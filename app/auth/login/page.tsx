    ...
    <div className="flex items-center justify-center min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-blue-400/10 to-indigo-600/10 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            rotate: [360, 0],
        ...
        <Card className="space-y-8 bg-white/70 backdrop-blur-xl border-0 shadow-2xl shadow-slate-200/50 rounded-3xl p-8">
          ...
          <div className="flex flex-col items-center gap-3">
            <motion.div
              ...
              className="w-16 h-16 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl flex items-center justify-center mb-2 shadow-lg shadow-blue-200/50"
            >
          ...
          >
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                disabled={loading}
                className="w-full px-4 py-3 rounded-xl border border-slate-200/70 bg-white/50 backdrop-blur-sm focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-200 placeholder:text-slate-400"
              />
            </div>
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-semibold py-3 rounded-xl shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 relative overflow-hidden group"
              disabled={loading}
            >
